...
namespace Alura.ListaLeitura.HttpClients
{
    public class LivroApiClient
    {
        ...
        public LivroApiClient(HttpClient client, AuthApiClient auth)
        {
            _httpClient = client;
            _auth = auth;
        }
        ...
        public async Task<byte[]> GetCapaLivroAsync(int id)
        {
           // var token = await _auth.PostLoginAsync(new LoginModel { Login = "admin", Password = "123" });
            // "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiJhZG1pbiIsImp0aSI6IjBiOGY5MGYzLTU1ZTktNGYyMi1hOGI3LTg2Nzg1Y2Q3ZjMxYSIsImV4cCI6MTYzOTg3MTM2NCwiaXNzIjoiQWx1cmEuV2ViQXBwIiwiYXVkIjoiUG9zdG1hbiJ9.W2Mi7rFUM3H1HA0QJKL442kcPZV355XnCsW6viPGpRI"
